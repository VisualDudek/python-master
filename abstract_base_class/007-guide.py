# Example of ABC with only partial abstractmethod
# TAKEAWAY: you can aleady define and implement methods
# that utilize abstractmethods that will be implemented later
...
def main():
    ...
    assert isinstance(pickle_writer, PickleHandler)
